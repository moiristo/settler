...
class TestSettler < MINITEST_CLASS
  ...
  def test_should_not_create_instance
    assert_raises(NoMethodError){ Settler.new }
  end
  ...
  def test_password_typecaster
    ...
    refute_equal '123456', password_value.untypecasted_value
    refute_equal password_value.value, password_value.untypecasted_value
